...
7. **Управление рисками** — при каждом аудите/code review/ADR записывать обнаруженные риски в `doc/архитектура/риски.md` (формат: §Процесс управления рисками)
...
- `doc/архитектура/риски.md` — реестр архитектурных и security рисков (40+ записей)

...
> **Мета-задача.** Декомпозирована на 6 подзадач. Реализация — последовательно (см. порядок ниже).
...
| **T2214.6** | Исправление гэпов прототипа (12 гэпов: layout, визуал, UX) | T2214.1–T2214.4 | `T2214.6-prototype-gaps/brief.md` |

**Порядок выполнения:** T2214.5 → T2214.1 → T2214.2 → T2214.3 → T2214.4 → T2214.6 (строго последовательно).

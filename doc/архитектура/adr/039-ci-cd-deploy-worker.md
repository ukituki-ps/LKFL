# ADR-039: CI/CD — serverAI self-hosted runners + Deploy Worker
...
- X-Tenant-ID sdek остаётся hardcoded (staging-only limitation)
...
- Деплой на стенд — staging docker-compose
